...
local InternalMethods = require("Interpreter/LuaInterpreter/Transformer/InternalMethods")
local NodeTransformations = require("Interpreter/LuaInterpreter/Transformer/NodeTransformations")
local ScopeManager = require("Interpreter/LuaInterpreter/Transformer/ScopeManager")
